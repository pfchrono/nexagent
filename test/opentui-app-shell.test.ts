...
test("OpenTUI app shell renders live view fields and Phase 66 command surfaces", async () => {
  ...
  assert.match(source, /keybindingAction === "paste-text"/);
  assert.match(source, /readClipboardText/);
  assert.match(source, /scheduleTextPasteFromClipboard/);
  assert.match(source, /clipboardPasteTimerRef/);
  assert.match(source, /activeKeybindings\["paste-text"\]/);
  assert.match(source, /createWindowsClipboardCommands/);
  ...
  assert.match(source, /keybindingAction === "copy-selection"/);
  ...
  assert.match(source, /keybindingAction === "quit"/);
  ...
  assert.match(source, /activeKeybindings\["copy-selection"\]/);
  assert.match(source, /activeKeybindings\["copy-latest"\]/);
  assert.match(source, /visiblePaletteWindow/);
  assert.match(source, /createPaletteDisplayRows/);
  assert.match(source, /formatPaletteRowText/);
  ...
  assert.match(source, /pendingQuestionnaire/);
  assert.match(source, /createAskPanel/);
  ...
  assert.match(source, /keybindingAction === "command-palette"/);
  assert.match(source, /kind: "open-command-palette"/);
  assert.match(source, /keybindingAction === "toggle-cockpit"/);
  ...
  assert.match(source, /provider · model · tools · approvals · sessions · extensions · MCP · LSP · memory · context/);
  ...
  assert.match(source, /activeKeybindings\["command-palette"\]/);
  assert.match(source, /activeKeybindings\["toggle-cockpit"\]/);
  assert.match(source, /activeKeybindings\["toggle-config"\]/);
  ...
  assert.match(source, /\.\.\.btwRows/);
  assert.match(source, /formatGoalOverlayRows\(session\.goal/);
  assert.match(source, /\.\.\.goalRows/);
  ...
  assert.match(source, /TODO_STATUS_VISIBLE_ROWS = 4/);
  assert.match(source, /renderTodoStatusRows\(todoRows, contentWidth, TODO_STATUS_VISIBLE_ROWS\)/);
  assert.match(source, /todo-status-overflow/);
  assert.match(source, /\.\.\. \$\{String\(hiddenCount\)\} more todos/);
  ...
  assert.match(source, /phaseLabel: formatTurnPhaseLabel\(view\)/);
  assert.match(source, /function formatTurnPhaseLabel\(view: OpenTuiRuntimeView\): string/);
  assert.match(source, /function renderModeStripLine\(options/);
  assert.match(source, /mode \$\{mode\}/);
  assert.match(source, /approval \$\{options\.view\.approval\}/);
  assert.match(source, /tools \$\{options\.view\.toolPolicy\}/);
  assert.match(source, /provider \$\{options\.view\.providerTransportMode\}/);
  assert.match(source, /statusLine: modeStripLine/);
  assert.match(source, /git \$\{gitLabel\}/);
  assert.match(source, /ctx \$\{contextBar\} \$\{contextLabel\} \$\{String\(options\.statusline\.contextPercent\)\}%/);
  assert.match(source, /phase \$\{options\.phaseLabel\}/);
  assert.match(source, /options\.width < 96/);
  assert.match(source, /tok \$\{formatCompactNumber\(tokensTotal\)\}/);
