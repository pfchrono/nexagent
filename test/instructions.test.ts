...
test("assemblePrompt keeps precedence layers distinct before serialization", async () => {
  ...
  try {
    ...
    assert.deepEqual(assembled.layers.toolAvailability, [
      ...
      "Available internal tools: read_file, write_file, apply_patch, batch_edit, preview_patch, list_dir, search_content, search_files, web_fetch, web_search, git_status, git_diff, shell_command, nexsight_execute, nexsight_read, nexsight_gather, nexsight_index, nexsight_batch, nexsight_search, archivist_save, archivist_checkpoint, mcp_list_tools, mcp_call, ask_user_question, todo, get_goal, update_goal, Agent, get_subagent_result, steer_subagent, lsp_status, lsp_symbols, lsp_diagnostics, lsp_navigation",
