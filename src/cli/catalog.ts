export const COMMAND_CATALOG = [
  ...
  { name: "/lsp", usage: "/lsp [status|setup|mode <on|off>|symbols <path>|diagnostics <path>|check [path]]", description: "inspect enabled local LSP code intelligence with bounded fallback" },
